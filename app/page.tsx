...
export default function Home() {
  ...
  const benefits = [
    {
      icon: Target,
      title: "Elimine a procrastinação",
      description:
        "Técnicas comprovadas para vencer a procrastinação definitivamente",
    },
    {
      icon: Focus,
      title: "Maximize seu foco",
      description: "Desenvolva concentração profunda e organize sua vida",
    },
    {
      icon: Timer,
      title: "Otimize sua rotina",
      description: "Crie sistemas eficientes que realmente funcionam",
    },
    {
      icon: Zap,
      title: "Ganhe tempo livre",
      description: "Tenha mais tempo para o que realmente importa",
    },
  ];
  ...
  const summaryItems = [
    {
      ...
      description:
        "Como seu cérebro funciona e como hackear sua mente para máxima eficiência",
      techniques: [
    ...
    },
    {
      ...
      description:
        "Domine a técnica mais eficaz de gestão de tempo com variações modernas",
    ...
    },
    {
      ...
      description:
        "Getting Things Done - metodologia completa para organização total",
    ...
    },
    {
      ...
      description:
        "Estratégias psicológicas baseadas em ciência comportamental",
      techniques: [
    ...
    },
    {
      ...
      description:
        "As melhores ferramentas digitais e como integrá-las perfeitamente",
    ...
    },
    {
      ...
      description:
        "Construa rotinas matinais e noturnas de pessoas altamente produtivas",
  ...
  const testimonials = [
    {
      ...
      text: "Este eBook revolucionou minha abordagem ao trabalho. Consegui aumentar minha produtividade em 40% mantendo o equilíbrio.",
      rating: 5,
    },
    {
      name: "Carlos Santos",
      role: "Estudante de Medicina",
      text: "As técnicas apresentadas me ajudaram a organizar meus estudos de forma eficiente. Recomendo para todos os estudantes.",
      rating: 5,
    },
    {
      name: "Maria Oliveira",
      role: "CEO Startup",
      text: "Conteúdo excepcional! Implementei os métodos na minha empresa e os resultados foram impressionantes.",
      rating: 5,
    },
  ];
  ...
  const faqItems = [
    {
      ...
      answer:
        "Você receberá o link para download por email imediatamente após a confirmação do pagamento.",
    },
    {
      question: "O conteúdo é compatível com dispositivos móveis?",
      answer:
        "Sim! O eBook está em formato PDF otimizado para leitura em smartphones, tablets e computadores.",
    },
    {
      question: "O conteúdo é adequado para iniciantes?",
      answer:
        "Absolutamente! O material foi desenvolvido com linguagem clara e exemplos práticos para todos os níveis.",
    },
    {
      question: "Como funciona a política de garantia?",
      answer:
        "Oferecemos 7 dias de garantia incondicional. Se não estiver satisfeito, devolvemos 100% do investimento.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#050a30] text-white">
          ...
          <div className="flex justify-between items-center h-12">
            ...
            <div className="hidden md:block">
              <div className="flex items-center space-x-4">
                <a
                  href="#beneficios"
                  className="text-slate-300 hover:text-[#3e8a36] px-2 py-1 text-sm font-medium transition-colors"
                >
                  Benefícios
                </a>
                <a
                ...
                <Link href="https://pay.kirvano.com/e6f0c774-a770-4064-b408-1c38e60f7388">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-[#050a30] border-t border-slate-700/50">
            <div className="px-2 pt-1 pb-2 space-y-1">
              <a
                href="#beneficios"
                className="block px-3 py-1.5 text-slate-300 hover:text-[#3e8a36] font-medium text-sm"
              >
                Benefícios
              </a>
              <a
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <h1 className="text-3xl md:text-5xl font-bold text-white mb-4 leading-tight">
                Domine Seu Tempo,
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3e8a36] to-[#4ade80]">
                  Transforme Sua Vida
                </span>
              </h1>

              <p className="text-lg text-slate-300 mb-6 leading-relaxed">
                O guia definitivo para produtividade e organização. Métodos
                comprovados para eliminar a procrastinação e maximizar seus
                resultados.
              </p>
              ...
              <div className="bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20 mb-6">
                <div className="text-center">
                  ...
                  <div className="text-4xl font-black text-[#3e8a36] mb-2">
                    R$ 20,00
                  </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Descubra métodos comprovados que vão revolucionar sua forma de
              trabalhar e viver
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="text-center p-8 rounded-2xl bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-all duration-300 border border-white/10"
              >
      ...
      <section
        id="sumario"
        className="py-20 bg-gradient-to-br from-[#0a1550] to-[#050a30]"
      >
          ...
          <div className="space-y-4">
            {summaryItems.map((item, index) => (
              ...
              >
                <button
                  onClick={() =>
                    setOpenSummary(openSummary === index ? null : index)
                  }
                  ...
                  <div className="px-6 pb-6 text-slate-300">
                    <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                      ...
                      <div className="space-y-2">
                        <p className="font-semibold text-[#3e8a36] text-sm">
                          Técnicas incluídas:
                        </p>
      ...
      <section id="garantia" className="py-20 bg-[#050a30]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-2xl text-slate-300 mb-10 leading-relaxed">
            7 dias para testar. Se não gostar, devolvemos 100% do seu
            investimento.
          </p>
          <div className="bg-white/5 backdrop-blur-sm p-10 rounded-2xl border border-white/10">
            <p className="text-slate-300 text-lg leading-relaxed">
              Temos total confiança na qualidade do nosso conteúdo. Por isso,
              oferecemos 7 dias de garantia incondicional. Se por qualquer
              motivo você não estiver satisfeito, devolvemos 100% do seu
      ...
      <section className="py-20 bg-gradient-to-br from-[#050a30] via-[#0a1550] to-[#050a30]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-slate-300 mb-10 leading-relaxed max-w-3xl mx-auto">
            Não perca esta oportunidade única. Comece hoje mesmo sua jornada
            rumo à produtividade máxima.
          </p>
          <div className="mb-10 p-8 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
            ...
            <p className="text-slate-300 text-lg">
              Investimento único • Transformação para toda vida
            </p>
          </div>
          <Link href="https://pay.kirvano.com/e6f0c774-a770-4064-b408-1c38e60f7388">
      ...
      <footer className="bg-black/50 backdrop-blur-sm text-white py-16 border-t border-white/10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-1 text-center">
            <div>
              <h3 className="text-2xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-[#3e8a36] to-[#4ade80]">
                Domine Seu Tempo
              </h3>
              <p className="text-slate-300 leading-relaxed mb-4">
                Transforme sua vida com produtividade e organização
                profissional.
              </p>
            </div>
          </div>
